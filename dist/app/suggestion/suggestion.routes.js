...
router.get("/singleForEditPage/:id", middlewares_1.verAdminTkn, suggestion_controller_1.singleForEditPage);
...
router.delete("/delete/:id", middlewares_1.verAdminTkn, (0, reusableControllers_1.deleteById)(suggestion_model_1.default));
