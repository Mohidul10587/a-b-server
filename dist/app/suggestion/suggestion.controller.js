...
exports.updateSuggestion =
  exports.deleteSuggestion =
  exports.create =
  exports.getSuggestionById =
...
const getSuggestionById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const suggestion = yield suggestion_model_1.default
        .findById(id)
        .populate({
          path: "products",
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const deletedSuggestion =
        yield suggestion_model_1.default.findByIdAndDelete(id);
