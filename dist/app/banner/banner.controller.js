...
exports.getBannersWithHomePageChecked =
  exports.updatePagesInBanners =
  exports.getBannersByWriter =
  exports.getBannersByCategory =
  exports.deleteBannerById =
  exports.getBannerById =
...
const createBanner = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const bannerUploads = yield Promise.all(
        bannersData.map((banner, index) =>
          __awaiter(void 0, void 0, void 0, function* () {
            const file = req.files.bannerImages[index];
            if (file) {
              const result = yield (0, uploadToCloudinary_1.uploadToCloudinary)(
                file.buffer
              );
              return {
...
const updateBannerById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const existingBanner = yield banner_model_1.default.findById(
        req.params.id
      );
      if (!existingBanner) {
      ...
      if (files && files.bannerImages && files.bannerImages.length > 0) {
        ...
        yield Promise.all(
          files.bannerImages.map((file, index) =>
            __awaiter(void 0, void 0, void 0, function* () {
              try {
                const result = yield (0,
                uploadToCloudinary_1.uploadToCloudinary)(file.buffer);
        ...
        console.log("Banner info", parsedBannersInfo);
      ...
      const updatedBanner = yield banner_model_1.default.findByIdAndUpdate(
        req.params.id,
        {
          title,
...
const getBannersByCategory = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getBannersByWriter = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getBannersWithHomePageChecked = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const banners = yield banner_model_1.default
        .find({
          "pages.title": "Home",
          "pages.checked": true,
        })
