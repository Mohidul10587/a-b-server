...
exports.allPublisherForFiltering =
  exports.getAllPublisherIds =
  exports.deletePublisher =
  exports.allForIndexPage =
  exports.getPublisherBySlug =
  exports.allForProductUploadPage =
  exports.getAllPublishers =
  exports.getPublisherById =
  exports.createPublisher =
    void 0;
      ...
      if (files instanceof Array) {
        imgFile =
          files === null || files === void 0
            ? void 0
            : files.find((f) => f.fieldname === "img");
        metaImgFile =
          files === null || files === void 0
            ? void 0
            : files.find((f) => f.fieldname === "metaImg");
      }
      const imgUrl = yield (0, uploadSingleFileToCloudinary_1.cloudinaryUpload)(
        imgFile
      );
      const metaImgUrl = yield (0,
      uploadSingleFileToCloudinary_1.cloudinaryUpload)(metaImgFile);
      const keywords = req.body.keywords.split(",").map((tag) => tag.trim());
      const updatePublisher = Object.assign(Object.assign({}, obj), {
        img: imgUrl ? imgUrl : obj.img,
        metaImg: metaImgUrl ? metaImgUrl : obj.metaImg,
        keywords: keywords,
      });
      if (obj._id) {
        const respondedPublisher =
          yield publishers_model_1.default.findOneAndUpdate(
        ...
        const { _id } = updatePublisher,
          elsePublisher = __rest(updatePublisher, ["_id"]);
        const respondedPublisher = yield publishers_model_1.default.create(
          elsePublisher
        );
        res.status(200).send({
          respondedPublisher,
...
const getPublisherById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const publisher = yield publishers_model_1.default.findById(
        req.params.id
      );
      if (!publisher) {
...
const getAllPublishers = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const publishers = yield Promise.all(
        previousPublishers.map((publisher) =>
          __awaiter(void 0, void 0, void 0, function* () {
            const productCount = yield product_model_1.default.countDocuments({
              publisher: publisher._id,
            });
            return Object.assign(Object.assign({}, publisher.toJSON()), {
...
const allForProductUploadPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // Fetch all publishers
      const previousPublishers = yield publishers_model_1.default
        .find()
        .select("title slug");
      // Fetch products and count products per publisher
...
//   }
// };
const getPublisherBySlug = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const publisher = yield publishers_model_1.default.findOne({
...
const allForIndexPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const publishers = yield publishers_model_1.default
        .find()
...
const deletePublisher = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const publisher = yield publishers_model_1.default.findByIdAndDelete(
        req.params.id
      );
      if (!publisher) {
        res.status(404).send({ error: "Publisher not found" });
...
const getAllPublisherIds = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const publisherIds = yield publishers_model_1.default
        .find()
        .select("slug")
        .lean();
...
// Get all
const allPublisherForFiltering = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
