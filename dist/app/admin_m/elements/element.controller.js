...
exports.updatePageElement =
  exports.updatePageElementStatus =
  exports.deletePageElementById =
  exports.getElementsByIdAndPage =
  exports.getElementByIdForUpdate =
  exports.getElementById =
  exports.createPageElement =
    void 0;
...
const createPageElement = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const images =
        (uploadedImages === null || uploadedImages === void 0
          ? void 0
...
const getElementById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
      const pageElement = yield element_model_1.PageElements.findById(
        id
      ).populate("bannerId");
      if (!pageElement) {
...
// Get PageElement by ID
const getElementByIdForUpdate = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
const getElementsByIdAndPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const findProducts = (element, postLimit) =>
        __awaiter(void 0, void 0, void 0, function* () {
          let products = [];
          // Check by category
          const categoryProducts = yield product_model_1.default
            .find({
          ...
          if (categoryProducts.length > 0) {
            ...
            const subCategoryProducts = yield product_model_1.default
              .find({
                subcategory: element.productSectionId,
              })
              .select(
                "_id title slug img sellingPrice regularPrice stockStatus"
              );
            if (subCategoryProducts.length > 0) {
              products = subCategoryProducts;
            } else {
              // Fallback to brand if no category or subcategory products found
              const writerProducts = yield product_model_1.default
                .find({
...
const deletePageElementById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
      const pageElement = yield element_model_1.PageElements.findByIdAndDelete(
        id
      );
      if (!pageElement) {
        return res.status(404).json({ message: "PageElement not found" });
...
// Update Page Element
const updatePageElement = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (files && files.images && files.images.length > 0) {
        ...
        yield Promise.all(
          files.images.map((file, index) =>
            __awaiter(void 0, void 0, void 0, function* () {
              try {
                const result = yield (0, uplCloudinary_1.uploadToCloudinary)(
                  file.buffer
                );
