...
router.get("/allOrdersForAdmin", middlewares_1.verAdminTkn, sellerOrder_controller_1.getAllOrdersForAdmin);
...
router.delete("/delete/:id", middlewares_1.verAdminTkn, (0, reusableControllers_1.deleteById)(sellerOrder_model_1.SellerOrderModel));
