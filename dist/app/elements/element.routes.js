...
router.post("/create", middlewares_1.verifyAdminToken, element_controller_1.create);
router.get("/allForIndexPageByTargetedPageAndId", middlewares_1.verifyAdminToken, element_controller_1.allForIndexPageByTargetedPageAndId);
...
router.put("/update/:id", middlewares_1.verifyAdminToken, element_controller_1.update);
