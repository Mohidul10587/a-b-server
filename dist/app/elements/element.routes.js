...
router.post("/create-page-element", middlewares_1.verifyAdminToken, element_controller_1.createPageElement);
...
router.put("/updateElement/:elementId", middlewares_1.verifyAdminToken, element_controller_1.updatePageElement);
