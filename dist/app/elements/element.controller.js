...
const getElementsByIdAndPage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const pageElements = yield element_model_1.PageElements.find({
            ...
            populate: {
                path: "products",
                select: "_id title slug img price unprice stockStatus existingQnt shippingInside shippingOutside",
            },
        });
        ...
        const findProducts = (element, postLimit) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            }).select("__id title slug img price unprice stockStatus existingQnt shippingInside shippingOutside");
