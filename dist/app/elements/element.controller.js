...
exports.allForIndexPageByTargetedPageAndId =
  exports.update =
  exports.updatePageElementStatus =
  exports.deletePageElementById =
  exports.elementById =
  exports.singleForEditPage =
...
// Get PageElement by ID
const singleForEditPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
const elementById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const updatedSections = yield Promise.all(
        pageElement.sections.map((sec) =>
          __awaiter(void 0, void 0, void 0, function* () {
            //@ts-ignore
            ...
            if (sec.selectionType === "category" && sec.category) {
              const products = yield model_1.default
                .find({ category: sec.category })
            ...
            if (sec.selectionType === "bestSellingPublications") {
              const publications = yield user_model_1.default
                .find({ role: "seller" })
...
const update = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const item = yield element_model_1.PageElements.findByIdAndUpdate(
        id,
        req.body,
        {
          new: true, // Return the updated document
...
const allForIndexPageByTargetedPageAndId = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
