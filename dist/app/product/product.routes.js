...
router.get(
  ...
  product_controller_1.getAllProductsForOfferPage
);
router.get(
  "/getProductsByCategorySlug/:slug",
  product_controller_1.getProductsByCategorySlug
);
router.get(
  "/products_by_punishers_slug/:slug",
  product_controller_1.getProductsByPublishersSlug
);
router.get(
  "/writer_products_by_slug/:slug",
  product_controller_1.getProductsByWriterSlug
);
router.get(
  "/singleForUserFoDetailsPageBySlug/:slug",
  product_controller_1.singleForUserFoDetailsPageBySlug
);
...
router.delete(
  "/:productId",
  middlewares_1.verifyAdminToken,
...
router.get(
  ...
  (0, reusableControllers_1.getAllSlugsForSitemap)(product_model_1.default)
);
