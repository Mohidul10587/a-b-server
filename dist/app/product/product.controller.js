...
exports.getExistingQuantity =
  ...
  exports.singleForUserFoDetailsPageBySlug =
  exports.update =
  exports.create =
    void 0;
...
const publishers_model_1 = __importDefault(
  require("../publishers/publishers.model")
);
...
const singleForUserFoDetailsPageBySlug = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      res.status(200).json({
        ...
        resData: Object.assign(Object.assign({}, product.toObject()), {
...
const getExistingQuantity = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json({
          ...
          respondedData:
            product === null || product === void 0
              ? void 0
              : product.existingQnt, // Optionally, include the created category in the response
        });
        return;
      }
      // if (type == "variant") {
