...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const newProduct = yield product_model_1.default.create(Object.assign(Object.assign({}, data), { slug: (0, generateSLug_1.generateSlug)(data.title) }));
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const updatedItem = yield product_model_1.default.findByIdAndUpdate(id, req.body, {
