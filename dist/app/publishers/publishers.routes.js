...
router.post("/create", middlewares_1.verifyAdminToken, uploadSingleFileToCloudinary_1.uploadMiddleware, publishers_controller_1.createPublisher);
...
router.delete("/:id", middlewares_1.verifyAdminToken, publishers_controller_1.deletePublisher);
