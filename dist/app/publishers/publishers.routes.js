...
router.post("/create", middlewares_1.verAdminTkn, uploadSingleFileToCloudinary_1.uploadMiddleware, publishers_controller_1.createPublisher);
...
router.delete("/:id", middlewares_1.verAdminTkn, publishers_controller_1.deletePublisher);
