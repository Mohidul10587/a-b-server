...
exports.rejectSellerApplicationByAdmin =
  exports.singleForUserForDetailsPageBySlug =
  exports.allSlugsForUserIndexPage =
  exports.allForUserIndexPage =
  exports.singleForAdmin =
  exports.allForAdminIndexPage =
  exports.update =
  exports.create =
    void 0;
...
const update = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const item = yield model_1.SellerApplication.findByIdAndUpdate(
        id,
        req.body,
        {
          new: true,
      ...
      if (!item)
        return res
          .status(404)
          .json({ message: "SellerApplication not found." });
      res
        .status(200)
...
const allForAdminIndexPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const singleForAdmin = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const item = yield model_1.SellerApplication.findOne({
        _id: req.params.id,
      }).populate("user", "name username email phone image");
...
// ================== User Controllers ======================
const allForUserIndexPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const items = yield model_1.SellerApplication.find().sort({
        createdAt: -1,
      });
      res.status(200).json(items);
    } catch (error) {
...
const allSlugsForUserIndexPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const items = yield model_1.SellerApplication.find(
        { display: true },
...
const singleForUserForDetailsPageBySlug = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const item = yield model_1.SellerApplication.findOne({
...
const rejectSellerApplicationByAdmin = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      ...
      // Find application
      const application = yield model_1.SellerApplication.findById(id).populate(
        "user"
      );
      if (!application) {
