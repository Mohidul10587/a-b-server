...
exports.deleteAllPageElements =
  exports.deletePageElementById =
  exports.getPageElementById =
...
const getPageElementById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
const deletePageElementById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const pageElement =
        yield element_model_1.HomePageElements.findByIdAndDelete(id);
      if (!pageElement) {
...
const deleteAllPageElements = (_req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
