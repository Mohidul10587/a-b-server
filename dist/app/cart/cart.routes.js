...
router.post("/updateProductQntInDb", middlewares_1.verUserTkn, cart_controller_1.updateProductQntInDb);
...
router.delete("/removeItemFromCart", middlewares_1.verUserTkn, cart_controller_1.removeItemFromCart);
router.patch("/update-isChecked", cart_controller_1.updateIsChecked);
router.delete("/delete/:id", (0, reusableControllers_1.deleteById)(cart_model_1.default));
