...
exports.deleteSubcategory = exports.getSubcategoryById = exports.updateSubcategory = exports.addSubcategory = exports.getAllCategoryIds = exports.deleteCategory = exports.findSubcategoryById = exports.getCategoryById = exports.getAllCategories = exports.updateCategory = exports.createCategory = void 0;
...
const createCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { categoryName, description, infoSections, display, displayPositionOfHomePage, subCategories, } = req.body;
        ...
        const photoResult = yield new Promise((resolve, reject) => {
            const uploadStream = cloudinary_config_1.default.uploader.upload_stream({ folder: "categories" }, (error, result) => {
                if (error || !result) {
        ...
        const fieldIcons = (files === null || files === void 0 ? void 0 : files.fieldIcons) || [];
        const sectionIcons = (files === null || files === void 0 ? void 0 : files.sectionIcons) || [];
        // Parallel upload for field icons
        const fieldIconsUploads = fieldIcons.map((file) => new Promise((resolve, reject) => {
            const uploadStream = cloudinary_config_1.default.uploader.upload_stream({ folder: "categories/fields" }, (error, result) => {
                if (error || !result) {
                    return reject(error || new Error("Upload failed, result is undefined"));
                }
        ...
        const sectionIconsUploads = sectionIcons.map((file) => new Promise((resolve, reject) => {
            const uploadStream = cloudinary_config_1.default.uploader.upload_stream({ folder: "categories/sections" }, (error, result) => {
                if (error || !result) {
                    return reject(error || new Error("Upload failed, result is undefined"));
                }
                resolve(result.secure_url);
...
const updateCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    try {
        const { categoryName, description, display, displayPositionOfHomePage, infoSections, } = req.body;
        ...
        const files = req.files;
        const photo = (_b = files === null || files === void 0 ? void 0 : files.photo) === null || _b === void 0 ? void 0 : _b[0];
        let photoResult;
        if (photo) {
        ...
        const updatedInfoSections = JSON.parse(infoSections).map((section) => {
            ...
            if (section.sectionIcon != null) {
                if (section.sectionIcon.includes("blob:") &&
            ...
            section.fields = section.fields.map((field) => {
                if (field.fieldIcon != null) {
                    if (field.fieldIcon.includes("blob:") &&
        ...
        for (const product of products) {
            const mergedInfoSections = (0, nergeInfoSection_1.mergeInfoSections)(updatedInfoSections, product.infoSectionsData);
            yield product_model_1.default.updateOne({ _id: product._id }, { $set: { infoSectionsData: mergedInfoSections } });
        }
...
const getAllCategories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const categories = yield Promise.all(previousCategories.map((category) => __awaiter(void 0, void 0, void 0, function* () {
...
const findSubcategoryById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    const subcategoryId = req.params.subCategoryId;
    console.log(subcategoryId);
    try {
        // Find the category containing the subcategory by its ID
        const category = yield category_model_1.default.findOne({ "subCategories._id": subcategoryId }, { "subCategories.$": 1 } // Only return the matching subcategory
        );
        if (!category || ((_c = category.subCategories) === null || _c === void 0 ? void 0 : _c.length) === 0) {
...
const getAllCategoryIds = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Fetch all categories and return only their  IDs
        const categories = yield category_model_1.default.find().select("_id").lean();
...
const addSubcategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const files = req.files;
        const subcategoryPhoto = (_d = files === null || files === void 0 ? void 0 : files.photo) === null || _d === void 0 ? void 0 : _d[0];
        if (!subcategoryPhoto) {
            return res.status(400).json({ error: "Subcategory photo is required" });
        }
        // Upload the subcategory photo to Cloudinary
        const photoResult = yield new Promise((resolve, reject) => {
            const uploadStream = cloudinary_config_1.default.uploader.upload_stream({ folder: "subcategories" }, (error, result) => {
                if (error || !result) {
                    return reject(error || new Error("Upload failed, result is undefined"));
                }
                resolve(result);
        ...
        (_e = category.subCategories) === null || _e === void 0 ? void 0 : _e.push(newSubcategory);
...
const updateSubcategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.log(subcategoryId);
        const files = req.files;
        const subcategoryPhoto = (_f = files === null || files === void 0 ? void 0 : files.photo) === null || _f === void 0 ? void 0 : _f[0];
        ...
        const subcategory = (_g = category.subCategories) === null || _g === void 0 ? void 0 : _g.find((sub) => sub._id.toString() === subcategoryId);
        if (!subcategory) {
...
const getSubcategoryById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const subcategory = (_h = category.subCategories) === null || _h === void 0 ? void 0 : _h.find((sub) => sub._id.toString() === subcategoryId);
        if (!subcategory) {
            return res.status(404).json({ error: "Subcategory not found" });
        }
...
const deleteSubcategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const subcategoryIndex = (_j = category.subCategories) === null || _j === void 0 ? void 0 : _j.findIndex((subcategory) => subcategory._id.toString() === subcategoryId);
        if (subcategoryIndex === -1 || subcategoryIndex === undefined) {
            return res.status(404).json({ error: "Subcategory not found" });
        }
        // Remove the subcategory from the subCategories array
        (_k = category.subCategories) === null || _k === void 0 ? void 0 : _k.splice(subcategoryIndex, 1);
        // Save the updated category
        yield category.save();
        res.status(200).json({
            success: true,
