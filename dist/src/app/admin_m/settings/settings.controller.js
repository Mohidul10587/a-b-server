...
exports.updateDefaultSellerStatus =
  exports.updateSettings =
  exports.getPrivacyPoliciesOfSettings =
  exports.getSettings =
    void 0;
...
const getPrivacyPoliciesOfSettings = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const settings = yield settings_model_1.default.findOne();
      if (!settings) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (settings) {
        ...
        settings.deliveryTime1 =
          req.body.deliveryTime1 || settings.deliveryTime1;
        settings.deliveryMethod2 =
          req.body.deliveryMethod2 || settings.deliveryMethod2;
        settings.deliveryTime2 =
          req.body.deliveryTime2 || settings.deliveryTime2;
        ...
        settings.officeAddress =
          req.body.officeAddress || settings.officeAddress;
        ...
        settings.otherPolicies =
          req.body.otherPolicies || settings.otherPolicies;
...
const updateDefaultSellerStatus = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const result = yield settings_model_1.default.findByIdAndUpdate(
