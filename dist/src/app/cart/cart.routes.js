...
router.post("/create", user_middleware_1.default, cart_controller_1.createOrUpdate);
...
router.get("/getUserCart/:userId", user_middleware_1.default, cart_controller_1.getUserCart);
