...
exports.updateIsChecked =
  exports.removeItemFromCart =
  exports.getUserCart =
  exports.updateProductQntInDb =
  exports.addSingleItemToCart =
...
const addSingleItemToCart = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateProductQntInDb = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      res.status(200).json({
        ...
        respondedData:
          (cart === null || cart === void 0 ? void 0 : cart.cartItems) || [],
      });
    } catch (error) {
