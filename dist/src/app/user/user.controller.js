...
exports.addCoins =
  ...
  exports.logOut =
  exports.updateUser =
  exports.getSingleUserForAddToCartComponent =
  exports.getContactInfoOfSingleUserBySlug =
  exports.getStatus =
  exports.getSingleUserById =
  exports.getSingleUserBySlug =
  exports.getSingleUser =
  exports.getAllUsers =
  exports.checkUser_Email =
  exports.logInWithEmailPassword =
  exports.signUp =
  exports.createUser =
    void 0;
...
const settings_model_1 = __importDefault(
  require("../admin_m/settings/settings.model")
);
...
const signUp = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sellerDefaultStatus =
      (_a = yield settings_model_1.default.findOne()) === null || _a === void 0
        ? void 0
        : _a.sellerDefaultStatus;
    try {
      const existingUser = yield user_model_1.default.findOne({ email });
      if (existingUser) {
...
const getSingleUserBySlug = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getContactInfoOfSingleUserBySlug = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const userSlug = req.params.userSlug;
      if (!userSlug) {
...
const getSingleUserForAddToCartComponent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const item = yield user_model_1.default
        .findOne({ _id: userId })
        .select(
...
const updateUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const photoUrl = yield (0,
      uploadSingleFileToCloudinary_1.cloudinaryUpload)(photoFile);
      if (photoUrl) {
        if (previousPhoto && isFromGoogleSite(previousPhoto) === false) {
          yield (0, extractPublicKeyAndDelete_1.extractPublicKeyAndDelete)(
            previousPhoto
          );
        }
      }
