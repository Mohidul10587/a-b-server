...
const createProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { title, description, category, generalDetails, platformDetails, price, stockStatus, brand, featured, sele, condition, warranty, youtubeVideo, shippingInside, shippingOutside, } = req.body;
