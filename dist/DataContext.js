...
const DataProvider = ({ children, session }) => {
  const [numberOfCartProduct, setNumberOfCartProducts] = (0, react_1.useState)(
    0
  );
  const [thisProductQuantity, setThisProductQuantity] = (0, react_1.useState)(
    0
  );
  ...
  (0, react_1.useEffect)(() => {
    ...
    if (session) {
      ...
      const storeUserDataInDatabase = (userData) =>
  ...
  const {
    ...
    mutate,
    isLoading,
  } = (0, swr_1.default)(`additionalSettings`, fetcher_1.fetcher);
  const additionalSettings =
    response === null || response === void 0 ? void 0 : response.respondedData;
  return (
